...
public class Task extends Todo {
    ...
    //    parses the description to extract meta-data (i.e., tags, status,
    //    priority and deadline).
    //    If description does not contain meta-data, the task is set to have no
    //    due date, status of 'To Do', and default priority level (i.e., not
    ...
    // EFFECTS: return estimated time in hours to complete the task
    @Override
    public int getEstimatedTimeToComplete() {
        return etcHours;
    }

    // EFFECTS: returns integer from 0 to 100 that represents percentage of the
    //          task completed
    @Override
    ...
    public void setProgress(int progress) throws InvalidProgressException {
        if (progress < 0 || progress > 100) {
            throw new InvalidProgressException("Invalid progress was entered");
        }
    ...
    public void setEstimatedTimeToComplete(int hours) throws NegativeInputException {
        if (hours < 0) {
            throw new NegativeInputException("Time cannot be negative");
        }
        etcHours = hours;
        setChanged();
    ...
    // MODIFIES: this
    // EFFECTS: parses the description to extract meta-data (i.e., tags, status,
    //          priority and deadline).
